...
function inv_return=stew_inverse(xsi,ysi,xmi,ymi,roll,pitch,yaw,px,py,pz,baseHeight,platformHeight)
    digits(15)                           %digit accuracy specification
    %baseHeight = -375.4572;
    %platformHeight = -263.8997;
    a1=[xsi(1);ysi(1);baseHeight;1];              
    a2=[xsi(2);ysi(2);baseHeight;1];              
    a3=[xsi(3);ysi(3);baseHeight;1];              
    a4=[xsi(4);ysi(4);baseHeight;1];              
    a5=[xsi(5);ysi(5);baseHeight;1];
    a6=[xsi(6);ysi(6);baseHeight;1]; 
    ...
    b1=T*[xmi(1);ymi(1);platformHeight;1];   %b# is the coordinates that will be used for calculation
    b2=T*[xmi(2);ymi(2);platformHeight;1];
    b3=T*[xmi(3);ymi(3);platformHeight;1];
    b4=T*[xmi(4);ymi(4);platformHeight;1];
    b5=T*[xmi(5);ymi(5);platformHeight;1];
    b6=T*[xmi(6);ymi(6);platformHeight;1];

    b1t=Ta*[xmi(1);ymi(1);platformHeight;1]; %b#t are the coordinates that will be animated
    b2t=Ta*[xmi(2);ymi(2);platformHeight;1];
    b3t=Ta*[xmi(3);ymi(3);platformHeight;1];
    b4t=Ta*[xmi(4);ymi(4);platformHeight;1];
    b5t=Ta*[xmi(5);ymi(5);platformHeight;1];
    b6t=Ta*[xmi(6);ymi(6);platformHeight;1];
