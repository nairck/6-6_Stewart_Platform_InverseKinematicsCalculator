function handle_reachable_scaler_selection(scaler, dlg, plotinfo, homeNewOld)
...
if isvalid(dlg)
    ...
    draw_reachable_workspace_spherical(scaler, plotinfo, homeNewOld);  % Pass plotinfo along with scaler
end
end